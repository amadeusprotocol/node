...
config :ama, :snapshot_height, (System.get_env("SNAPSHOT_HEIGHT") || "77736265") |> :erlang.binary_to_integer()
...
#Bind Interaces
#`mix test` always runs offline: a network-connected test node pulls live gossip
#into the shared TXPool and flakes tests that assume an isolated pool. Mix is
